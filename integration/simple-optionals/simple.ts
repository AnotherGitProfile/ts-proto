...
export interface Nested_Original {
  name: string;
  message?: Nested_InnerMessage_Original;
  state: Nested_InnerEnum;
}
...
export interface Nested_InnerMessage_Original {
  name: string;
  deep?: Nested_InnerMessage_DeepMessage_Original;
}
