...
export const Numbers = {
  ...
  toWrapped(message: Numbers): Numbers_Original {
    ...
    message.int64 !== undefined && message.int64 !== null && (obj.int64 = (message.int64 || Long.ZERO).toString());
    message.uint32 !== undefined && message.uint32 !== null && (obj.uint32 = message.uint32);
    message.uint64 !== undefined && message.uint64 !== null && (obj.uint64 = (message.uint64 || Long.UZERO).toString());
    message.sint32 !== undefined && message.sint32 !== null && (obj.sint32 = message.sint32);
    message.sint64 !== undefined && message.sint64 !== null && (obj.sint64 = (message.sint64 || Long.ZERO).toString());
    message.fixed32 !== undefined && message.fixed32 !== null && (obj.fixed32 = message.fixed32);
    message.fixed64 !== undefined && message.fixed64 !== null && (obj.fixed64 = (message.fixed64 || Long.UZERO).toString());
    message.sfixed32 !== undefined && message.sfixed32 !== null && (obj.sfixed32 = message.sfixed32);
    message.sfixed64 !== undefined && message.sfixed64 !== null && (obj.sfixed64 = (message.sfixed64 || Long.ZERO).toString());
    return obj;
  },
