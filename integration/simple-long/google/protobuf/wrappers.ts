...
export const Int64Value = {
  ...
  toWrapped(message: Int64Value): Int64Value_Original {
    const obj: any = {};
    message.value !== undefined && message.value !== null && (obj.value = (message.value || Long.ZERO).toString());
    return obj;
  },
...
export const UInt64Value = {
  ...
  toWrapped(message: UInt64Value): UInt64Value_Original {
    const obj: any = {};
    message.value !== undefined && message.value !== null && (obj.value = (message.value || Long.UZERO).toString());
    return obj;
  },
