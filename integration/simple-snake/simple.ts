...
export const Simple = {
  encode(message: Simple, writer: Writer = Writer.create()): Writer {
    ...
    if (message.created_at !== undefined && message.created_at !== null && message.created_at !== undefined) {
  ...
  fromWrappedPartial(object: DeepPartial<Simple_Original>): Simple {
    ...
    if (object.grand_children !== undefined && object.grand_children !== null) {
      for (const e of object.grand_children) {
        message.grand_children.push(Child.fromWrappedPartial(e));
      }
    }
    if (object.coins !== undefined && object.coins !== null) {
      for (const e of object.coins) {
  ...
  toWrapped(message: Simple): Simple_Original {
    ...
    message.created_at !== undefined && message.created_at !== null && (obj.created_at = toTimestamp(message.created_at));
...
export const SimpleWithSnakeCaseMap = {
  ...
  fromWrappedPartial(object: DeepPartial<SimpleWithSnakeCaseMap_Original>): SimpleWithSnakeCaseMap {
    ...
    if (object.entities_by_id !== undefined && object.entities_by_id !== null) {
      Object.entries(object.entities_by_id).forEach(([key, value]) => {
        if (value !== undefined) {
          message.entities_by_id[Number(key)] = Entity.fromWrappedPartial(value);
        }
      })
    }
    return message;
  ...
  toWrapped(message: SimpleWithSnakeCaseMap): SimpleWithSnakeCaseMap_Original {
    ...
    if (message.entities_by_id) {
      Object.entries(message.entities_by_id).forEach(([k, v]) => {
        obj.entities_by_id[k] = Entity.toWrapped(v);
      })
    }
    return obj;
  },
